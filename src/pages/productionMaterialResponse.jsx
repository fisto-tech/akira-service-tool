              ...
              <div className="p-[1.2vw] bg-gray-50/50">
                ...
                <div className="grid grid-cols-3 gap-[1vw]">
                  {['assembledBy', 'testedBy', 'fiBy'].map(role => {
                    ...
                    return (
                      <div key={role} className="bg-white border border-gray-200 rounded-[0.5vw] p-[0.8vw] flex items-center gap-[0.8vw] shadow-sm">
                      ...
                      return products.map((prod, pi) => {
                        ...
                        return (
                          <tr key={`${row.id}-${pi}`} className={`transition-colors hover:bg-gray-50/60 ${pi > 0 ? "border-t border-dashed border-gray-300" : "border-t border-gray-300"}`}>
                            ...
                            <td className="px-[0.8vw] py-[0.7vw] border-r border-gray-300 align-middle text-center">
                              <div className="text-[0.72vw] text-gray-800 font-medium truncate max-w-[7vw] mx-auto text-center" title={prod.delayTime || "—"}>{prod.delayTime || "—"}</div>
                            </td>
